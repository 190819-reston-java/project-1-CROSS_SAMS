...
public class Dao{
	...
	String MANAGERSQL = "SELECT * public.manager_table WHERE email = ? AND manager_password = ?;";
	String EMPLOYEESQL = "SELECT * public.employee_table WHERE email = ? AND employee_password = ?;";
